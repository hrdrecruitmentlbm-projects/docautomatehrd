 ...
 * Phase 1 flips only /dashboard to "shell". Phase 2 migrates the rest
 * (one flag flip + delete the page's header block).
 *
...
export function resolveRouteMeta(pathname) {
  ...
  if (generateMatch) {
    ...
    return {
      ...
      subtitle: "Lengkapi data untuk membuat dokumen.",
      headerMode: "shell",
      primary: null,
