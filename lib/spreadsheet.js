...
export function mapMasterRows(headers, rows) {
  ...
  for (const row of rows) {
    ...
    // Baris footer/rekap ("TOTAL") bukan karyawan — lewati agar tidak jadi
    // data pegawai dan tidak dilaporkan sebagai nama ganda.
    if (/^(total|jumlah|subtotal|grand\s*total)$/i.test(namaAsli)) continue;
